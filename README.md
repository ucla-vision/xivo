...
*Demo video taken in Boelter Hall at UCLA.* Our system runs in real-time on data captured by a RealSense i435D sensor. More demos are available at the [demo page](demo.md).
